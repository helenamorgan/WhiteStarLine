...
# Open the lidardata file and read in the data by row 
...
# Open the radardata file and read in the data by row 
...
iceberg = IcebergCalculations.IcebergCalc(lidardata, radardata, seaice_m) # Define IcebergCalc class
...
# Gather the volume, mass and whether the iceberg can be towed and assign to a variable
total_volume = iceberg.total_volume() # Total volume of the iceberg 
total_mass = iceberg.total_mass() # Total mass of the iceberg 
determine_drag = iceberg.determine_drag() # If the iceberg can be towed or not 
...
volume_text = tk.Label(window, text='The volume (m^3) of the iceberg is', fg='white', bg='blue') # Display the total volume
volume_num = tk.Label(window, text = iceberg_volume.get(), fg='white', bg='blue') # Display the total volume
mass_text = tk.Label(window, text='The mass (kg) of the iceberg is', fg='white', bg='blue') # Display the total mass
